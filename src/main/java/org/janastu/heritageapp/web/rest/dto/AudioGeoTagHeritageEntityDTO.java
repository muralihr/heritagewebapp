...
/**
 * A DTO for the AudioGeoTagHeritageEntity entity.
 */
public class AudioGeoTagHeritageEntityDTO implements Serializable {
    ...
    private String audioFileContentType;
    ...
    public boolean equals(Object o) {
        ...
        AudioGeoTagHeritageEntityDTO audioGeoTagHeritageEntityDTO = (AudioGeoTagHeritageEntityDTO) o;

        if ( ! Objects.equals(id, audioGeoTagHeritageEntityDTO.id)) return false;
